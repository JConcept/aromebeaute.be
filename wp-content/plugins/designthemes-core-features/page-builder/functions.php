...
if ( ! function_exists('dt_generate_widget_options') ){
	function dt_generate_widget_options( $module_name, $dt_module_exact_name ){
		...
		if($module_name == 'WP_Widget_Text') {
			...
			$dt_widgets[$module_name]['form'] = str_replace('id="widget-text--filter"', 'id="widget-text--filter" placeholder="filter"', $dt_widgets[$module_name]['form']);
			$dt_widgets[$module_name]['form'] = str_replace('id="widget-text--visual"', 'id="widget-text--visual" placeholder="visual"', $dt_widgets[$module_name]['form']);
		}
		
		if($module_name == 'WP_Widget_Media_Image') {
			$dt_widgets[$module_name]['form'] = str_replace('hidden', 'text', $dt_widgets[$module_name]['form']);

...
$dtthemes_columns['fullwidth_video'] = array( 
	'name' => __('Fullwidth Video', 'dt_themes'),
	'type' => 'section',
	'options' => array(
		'mp4' => array(
...
$dt_modules['general']['testimonial_carousel'] = array(
	...
	'options' => array(
		...
		'tmc_content' => array(
			...
			'is_content' => true,
			'default_value' => '<ul>
					<li>[dt_sc_testimonial image="https://placehold.it/300" name="John Doe" role="Cambridge Telcecom"]Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi hendrerit elit turpis, a porttitor tellus sollicitudin at. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.[/dt_sc_testimonial]</li>
					<li>[dt_sc_testimonial image="https://placehold.it/300" name="John Doe" role="Cambridge Telcecom"]Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi hendrerit elit turpis, a porttitor tellus sollicitudin at. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.[/dt_sc_testimonial]</li>
					<li>[dt_sc_testimonial image="https://placehold.it/300" name="John Doe" role="Cambridge Telcecom"]Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi hendrerit elit turpis, a porttitor tellus sollicitudin at. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.[/dt_sc_testimonial]</li>
				</ul>'
		)
...
$dt_modules['general']['doshortcode_icon_box_type6'] = array(
	...
	'options' => array(
		'tf_content' => array(
			...
			'type' => 'wp_editor',
			'is_content' => true,
			'default_value' => '[dt_sc_icon_box_with_image type =" type6" image_url="https://dummyimage.com/100X100" image_alt="" image_title="" title="Well Trained Professionals" link="#" target="_blank" description="Nunc at pretium est curabitur commodo leac est venenatis egestas sed aliquet auguevelit." ]
...
$dt_modules['unique']['spa_procedure'] = array(
	...
	'options' => array(
		...
		'image_link' => array(
			...
			'type' => 'upload',
			'default_value' => 'https://dummyimage.com/1170x810/a399a3/13131f&amp;text=Image'
		),
...
$dt_modules['unique']['book_appointment'] = array(
	...
	'options' => array(
		'ibc_content' => array(
			...
			<br>[dt_sc_online_form url="https://www.google.com" /]</br>'
		)
	)
);

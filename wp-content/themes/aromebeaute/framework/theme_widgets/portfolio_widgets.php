...
class MY_Portfolio_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(false,IAMD_THEME_NAME.__(' Portfolio','spalab'),$widget_options);
	}
	...
	function form($instance) {
        ...
        <p><label for="<?php echo ( $this->get_field_id('_excerpt') );?>"><?php _e('Display title only or title &amp; excerpt','spalab');?></label>
	    ...
	    <p><label for="<?php echo esc_attr( $this->get_field_id('_post_count') ); ?>"><?php _e('No.of posts to show:','spalab');?></label>
	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-portfolio-widget'><ul>";		
			 ...
			 endwhile;
			 	...
			 	echo "<li>".__('No Portfolio Entries found','spalab')."</li>";
			 endif;
			 wp_reset_query();
	 	echo "</ul></div>";			 
		echo ( $after_widget );

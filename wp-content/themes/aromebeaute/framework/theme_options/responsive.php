...
<div id="mobile" class="bpanel-content">
  <!-- .bpanel-main-content -->
    <div class="bpanel-main-content">
        <ul class="sub-panel">
            <li><a href="#my-responsive"><?php _e("Responsive",'spalab');?></a></li>        
        </ul>
        ...
        <div id="my-responsive" class="tab-content">
        	<div class="bpanel-box">
                ...
                <div class="box-title"><h3><?php _e('Responsive','spalab');?></h3></div>
                <div class="box-content">
                
	                <div class="one-half-content">
    	            	<div class="bpanel-option-set">
                          <h6><?php _e("Make My Site Responsive",'spalab');?></h6>
                          ...
                          <p class="note"><?php _e('Choose whether you need responsive version for your website','spalab');?></p>
        	            </div>
                     </div>

	                <div class="one-half-content last">
    	            	<div class="bpanel-option-set">
	                      <h6><?php _e('Disable Slider for Mobile Devices','spalab');?></h6>
                          ...
                          <p class="note"><?php _e('Choose whether you wish to hide / display the slider area of your website on mobile devices','spalab');?></p>
        	            </div>
                    </div>

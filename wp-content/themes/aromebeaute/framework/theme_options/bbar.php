...
<div id="bbar" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">
            <li><a href="#my-bar"><?php _e("Bar Settings",'spalab');?></a></li>
        </ul>
        ...
        <div id="my-bar" class="tab-content">
            ...
            <div class="bpanel-box">
		        <div class="box-title"><h3><?php _e('Bar Settings','spalab');?></h3></div>
                <div class="box-content">
                	
                    <div class="column one-half">
                    	<h6><?php _e('Enable Bar','spalab');?></h6>
	                	<?php dttheme_switch("",'bbar','show-bbar');?>
                    </div>

                    <div class="column one-half last">
                    	<h6><?php _e('Hide Bar by default','spalab');?></h6>
        	...
        	<div class="bpanel-box">
            	<div class="box-title"><h3><?php _e('Message Settings','spalab');?></h3></div>
                <div class="box-content">
                     
                     <div class="bpanel-option-set">
                         <h6><?php _e('Message','spalab');?></h6>
                    ...
                    <div class="column one-column"> 
                        <div class="bpanel-option-set">
							<?php dttheme_admin_fonts(__('Message Font','spalab'),'mytheme[bbar][message-font]',dttheme_option('bbar','message-font'));?>
                            <div class="clear"></div>
                            <p class="note"><?php _e("Choose Message Font",'spalab');?></p>
                        </div>                        
                    </div>
                    ...
                    <div class="column one-half">
                        <?php $label = 		__("Message Font Color",'spalab');
                          ...
                          $tooltip = 	__("Pick a custom font color for the message e.g. #a314a3",'spalab'); ?>
                          <h6> <?php echo ( $label );?> </h6>
                          <?php dttheme_admin_color_picker("",$name,$value,'');?>
                          <p class="note no-margin"><?php echo ( $tooltip );?></p>     
                    </div>
                    <div class="column one-half last">
						<?php dttheme_admin_jqueryuislider(__('Message Font Size','spalab'),"mytheme[bbar][message-font-size]",
                    ...
                    <div class="column one-third">
                    	<h6><?php _e('Disable Font Color','spalab');?></h6>   
                        <?php dttheme_switch("",'bbar','disable-message-font-color');?>
                    </div>
                    
                    <div class="column one-third"> 
                        <?php $label = 		__("Link Color",'spalab');
                          $name  =		"mytheme[bbar][link-color]";	
                          $value =  	 (dttheme_option('bbar','link-color')!= NULL) ? dttheme_option('bbar','link-color') : "#";
                          $tooltip = 	__("Pick a custom primary color for the links in buddha bar e.g. #564912 ",'spalab'); ?>
                          <h6><?php echo ( $label );?></h6>	
                          <?php dttheme_admin_color_picker('',$name,$value,'');?> 
                          <p class="note"><?php echo ( $tooltip );?></p>                    
                    </div>
                    ...
                    <div class="column one-third last">
                        <?php $label = 		__("Link hover Color",'spalab');
                          $name  =		"mytheme[bbar][link-hover-color]";	
                          $value =  	 (dttheme_option('bbar','link-hover-color')!= NULL) ? dttheme_option('bbar','link-hover-color') : "#";
                          $tooltip = 	__("Pick a custom hover state color for the links in buddha bar e.g. #564912 ",'spalab'); ?>
						  <h6><?php echo ( $label );?></h6>	
                          <?php dttheme_admin_color_picker('',$name,$value,'');?>                    
                          <p class="note"><?php echo ( $tooltip );?></p> 
                    </div>

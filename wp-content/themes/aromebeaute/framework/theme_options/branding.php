...
<div id="branding" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">
            <li><a href="#my-admin"><?php _e("Admin",'spalab');?></a></li>
        </ul>
        ...
        <div id="my-admin" class="tab-content">
        	<div class="bpanel-box">
                ...
                <!-- Buddha Panel logo -->
                <div class="box-title">
                   <h3><?php _e('Buddha Panel Logo','spalab');?></h3>
                </div>
                
                <div class="box-content">
                	<h6> <?php _e('Replace Buddha Panel Logo','spalab');?> </h6>
                    ...
                    <p class="note"> <?php _e('Upload an image to replace the default buddha panel logo.<b><i>You can set your own brnad</i></b>. ','spalab');?> </p>

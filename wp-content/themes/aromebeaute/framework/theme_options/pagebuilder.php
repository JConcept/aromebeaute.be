...
<div id="pagebuilder" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel"> 
            <li><a href="#my-pagebuilder"><?php _e("Page Builder",'spalab');?></a></li>
        </ul>
        ...
        <div id="my-pagebuilder" class="tab-content">
            ...
            <div class="bpanel-box">
                <div class="box-title">
                    <h3><?php _e('Page Builder','spalab');?></h3>
                </div>
                
                <?php
				$dt_pb_status = dttheme_is_plugin_active('designthemes-core-features/designthemes-core-features.php');
				
				if ( is_plugin_active_for_network('designthemes-core-features/designthemes-core-features.php') ||  is_plugin_active('designthemes-core-features/designthemes-core-features.php')) {
				?>
                <div class="box-content">
                
                    <div class="bpanel-option-set">
                    
						<h6><?php esc_html_e('Choose any of these post types to activate page builder', 'spalab');?></h6><?php
						//Getting post types...
                    ...
                    <div class="bpanel-option-set">
						...
						?>
                         <h6><?php _e('Keep page builder active in above selected post types','spalab'); ?></h6>
                    ...
                    <div class="bpanel-option-set">
						...
						?>
                        <h6><?php esc_html_e('Update page contents for latest page builder', 'spalab'); ?></h6>
                        <input type="button" value="<?php esc_attr_e('Update Content','spalab');?>" class="dt_update_pagebuilder_contents <?php echo ( $disable_cls ); ?>" />
						<p class="note"><?php esc_html_e('Latest page builder update needs your content to be updated. Please click the above button to update it. It may take while please be patient.','spalab');?></p>
                        <div class="hr"></div>
          ...
          <?php } else { ?>
                	...
                	<div class="bpanel-box">
                    	 <div class="bpanel-option-set">
                            <p class="note"><?php _e('Please activate "DesignThemes Core Features Plugin" to get the Page Builder options.','spalab');?></p>
                        </div>
                    </div>

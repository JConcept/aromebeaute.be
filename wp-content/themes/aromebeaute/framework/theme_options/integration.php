...
<div id="integration" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">   
            <li><a href="#integration-general"><?php _e("General",'spalab');?></a></li>
            <li><a href="#integration-post"><?php _e("Post",'spalab');?></a></li>
            <li><a href="#integration-page"><?php _e("Page",'spalab');?></a></li>
            <li><a href="#integration-portfolio"><?php _e("Portfolio",'spalab');?></a></li>
        </ul>
        ...
        <div id="integration-general">
        	<?php $integration_general = array( 
					array(
						"title"=>		__('Add Code Inside the &lt;head&gt','spalab'),
						"tooltip"=>		__('Any java script custom code you can place here will appear in the head section of every page of your site.ex: alert("test")','spalab'),
						"textarea"=>	"header-code",
						"checkbox"=>	"enable-header-code",
						"label"=>		__('Enable Header Code','spalab')
					),
					array(
						"title"=>		__('Add Code above &lt;/body&gt;','spalab'),
						"tooltip"=>		__('Any java script custom code you can place here will appear in the head section of every page of your site.ex: alert("test")','spalab'), 
						"textarea"=>	"body-code",
						"checkbox"=>	"enable-body-code",
						"label"=>		__('Enable Body Code','spalab')
					),
					array(
						"title"=> 	__('Custom CSS','spalab'),
						"tooltip"=>		__('Paste your custom CSS code here.','spalab'), 
						"textarea"=>	"custom-css",
						"checkbox"=>	"enable-custom-css",
						"label"=>		__('Enable Custom CSS','spalab')
						
					),
                    array(
                        "title"=>   __('Tracking Code','spalab'),
                        "tooltip"=>     __('Paste your tracking code here.','spalab'), 
                        "textarea"=>    "tracking-code",
                        "checkbox"=>    "enable-tracking-code",
                        "label"=>       __('Enable Tracking Code','spalab')
	  ...
	  <?php endforeach;?>
        ...
        <?php $integration_post = array(
					array(
						"title"=>		__('Add code to the top of your posts','spalab'),
						"tooltip"=>		__('Place any codes to show on top of all single post. This is useful if you are looking to integrate things such as social bookmarking links, AD etc.,.','spalab'),
						"textarea"=>	"single-post-top-code", 
						"checkbox"=>	"enable-single-post-top-code",
						"label"=>		__('Enable single post top code','spalab')
					),
					array(
						"title"=>		__('Add code to the bottom of your posts, before the comments','spalab'),
						"tooltip"=>		__('Place any codes to show on bottom of all single post. This is useful if you are looking to integrate things such as social bookmarking links, AD etc.,.','spalab'),
						"textarea"=>	"single-post-bottom-code",
						"checkbox"=>	"enable-single-post-bottom-code",
						"label"=>		__('Enable single post bottom code','spalab')
					));
        ...
        <?php	endforeach;?>
            ...
            <div class="bpanel-box">
                ...
                <div class="box-title">
                    <h3><?php _e("Social Shares",'spalab'); ?></h3>
                </div>
                
                <div class="box-content">
                 <p class="note no-margin"><?php _e("Manage social share options and its layout to show in the blog post.",'spalab')?></p>
            ...
            <div class="bpanel-box">
                <div class="box-title">
                    <h3><?php _e("Social Bookmark",'spalab'); ?></h3>
                </div>
                <div class="box-content">
	                <p class="note no-margin"><?php _e("Manage social media bookmark options and its layout to show in the blog post",'spalab')?></p>
                	<?php global $dttheme_social_bookmarks;
					  $count = 1;
						foreach($dttheme_social_bookmarks as $social_bookmark):?>
                        <div class="one-half-content <?php echo ($count%2 == 0)?"last":''; ?>">
        ...
        <div id="integration-page">
        	<?php $integration_page = array( 
					array(
						"title"=>		__('Add code to the top of your pages','spalab'),
						"tooltip"=>		__('Place any codes to show on top of all single page. This is useful if you are looking to integrate things such as social bookmarking links, AD etc.,.','spalab'),
						"textarea"=>	"single-page-top-code",
						"checkbox"=>	"enable-single-page-top-code",
						"label"=>		__('Enable single page top code','spalab')
					),
					array(
						"title"=>		__('Add code to the bottom of your pages, before the comments','spalab'),
						"tooltip"=>		__('Place any codes to show on bottom of all single page. This is useful if you are looking to integrate things such as social bookmarking links, AD etc.,.','spalab'),
						"textarea"=>	"single-page-bottom-code",
						"checkbox"=>	"enable-single-page-bottom-code",
						"label"=>		__('Enable single page bottom code','spalab')
					)
				);
	  ...
	  <?php endforeach;?>
            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                 ...
                 <p class="note no-margin"><?php _e("Manage social share options and its layout to show in the page.",'spalab')?></p>
            ...
            <!-- .bpanel-box-->
            <div class="bpanel-box">
               <div class="box-title"><h3><?php _e("Social Bookmark",'spalab'); ?></h3></div>
               <div class="box-content">
               	<p class="note no-margin"><?php _e("Manage social media bookmark options and its layout to show in the page.",'spalab')?></p>
               <?php global $dttheme_social_bookmarks;
                      $count = 1;
                      foreach($dttheme_social_bookmarks as $social_bookmark):?>
                        <div class="one-half-content <?php echo ($count%2 == 0)?"last":''; ?>">
        ...
        <div id="integration-portfolio">
            ...
            <div class="bpanel-box">
               ...
               <div class="box-content">
               <p class="note no-margin"><?php _e("Manage social media bookmark options and its layout to show in the portfolio.",'spalab');?></p>
               <?php global $dttheme_social_bookmarks;
                      $count = 1;
                      foreach($dttheme_social_bookmarks as $social_bookmark):?>
                        <div class="one-half-content <?php echo ($count%2 == 0)?"last":''; ?>">
